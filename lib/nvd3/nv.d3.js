...
nv.models.stackedArea = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , duration = 250
        , brushResponse = {} // function for brushing callback
        , brushLevel = 'sequence'// level of brush, default sequence, could be cluster
        , svgID = '#svgID'
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            path.enter().append('path')
                .attr('class', function(d,i) {
                    if(typeof d.lineContent == 'undefined')
                        return 'nv-area nv-area-' + i + ' nv-area-id-' + d.key.slice(1);
                    return 'nv-area nv-area-' + i + ' stack-sequence-' + d.lineContent.slice(1) + ' stack-cluster-' + d.clusterId;
                })
                .attr('d', function(d,i){
                ...
                .on('mouseover', function(d,i) {
                    if(typeof d.lineContent == 'undefined') {
                        //d3.select(this).classed('hover', true);
                        d3.selectAll('.stack-sequence-' + d.key.slice(1));
                    }
                    else {
                        d3.selectAll('.stack-sequence-' + d.lineContent.slice(1)).classed('hover', true);
                    }
                ...
                .on('mouseout', function(d,i) {
                    ...
                    //d3.select(this).classed('hover', false);
                        ...
                        d3.selectAll('.stack-sequence-'+ d.lineContent.slice(1)).classed('hover', false);
                    //d3.selectAll('.nv-area').classed('unselected', false);
                    //d3.selectAll('.stack-sequence-'+ d.lineContent.slice(1)).classed('selected', false);
                ...
                .on('click', function(d,i) {
                    brushResponse(d, data, g, brushLevel, svgID);
                    d3.select(this).classed('hover', false);
                });
    ...
    chart._options = Object.create({}, {
        ...
        interpolate:    {get: function(){return interpolate;}, set: function(_){interpolate=_;}},
        brushResponse:    {get: function(){return brushResponse;}, set: function(_){brushResponse=_;}},
        brushLevel:    {get: function(){return brushLevel;}, set: function(_){brushLevel=_;}},
        svgID:    {get: function(){return svgID;}, set: function(_){svgID=_;}},
